let fs = require('fs') 
 ...
        await this.setBio(`🎂️ Ultah Praszz UwU : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik
⏲️ Runtime: ${uptime} | 🛰 Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Only Group' : 'Public'} | 💌 Made PRASz UwU`).catch(_ => _)  
