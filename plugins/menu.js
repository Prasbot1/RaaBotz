 ...
 *Powered By @${'6289666747744'.split('@')[0]}*`
 ...
 const ftroli = {
    ...
    status: 1,
    surface : 1,
    message: `ShirooBotz-MD By Prasz`, 
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://telegra.ph/file/f32f779ce8eaf70158228.jpg')).buffer(), //Gambarnye
    sellerJid: '0@s.whatsapp.net' 
    }
...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: { title: `💌 Ultah Prasz : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`, body: `${pickRandom(['Follow My Instagram Plis •~•'])}`, sourceUrl: 'https://www.instagram.com/inizenscuy/', thumbnail: await (await fetch('https://telegra.ph/file/dffdaf0e8d59ad104e526.jpg')).buffer(),}} 
     })
} catch (e) { 
